...
iso_file           = "en-us_windows_11_business_editions_version_22h2_updated_feb_2023_x64_dvd_4e45f23d.iso"
...
scripts = ["scripts/windows/windows-prepare.ps1", "scripts/windows/windows-install-chocolatey.ps1"]
inline = [
