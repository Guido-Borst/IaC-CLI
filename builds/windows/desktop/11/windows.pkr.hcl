...
build {
  ...
  # upload unattend file for sysprep
  provisioner "file" {
    source = "scripts/windows/minimal-skip-oobe-unattend.xml"
    destination = "C:\\minimal-skip-oobe-unattend.xml"
  }
  ...
  provisioner "powershell" { 
    ...
    "Get-ItemProperty -Path HKLM:\\SOFTWARE\\Microsoft\\Windows\\CurrentVersion\\Setup\\State",
    "wmic useraccount get name,sid",
    "New-ItemProperty -Path $RegistryPath -Name $Name -Value $Value -PropertyType DWORD -Force",
    "Start-Process -FilePath C:\\Windows\\System32\\Sysprep\\Sysprep.exe -ArgumentList \"/generalize /mode:vm /oobe /quiet /shutdown /unattend:C:\\minimal-skip-oobe-unattend.xml\"",
    "Start-Sleep -s 180"]
  }
